...
"""autogenerated by genpy from slam/DoubleOccupancyGrid.msg. Do not edit."""
import codecs
import sys
...
class DoubleOccupancyGrid(genpy.Message):
  _md5sum = "928772a4fd242ce392b6f2fbccdd0b78"
  _type = "slam/DoubleOccupancyGrid"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# header - same
...
"""
  ...
  _slot_types = ['std_msgs/Header','nav_msgs/MapMetaData','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoubleOccupancyGrid, self).__init__(*args, **kwds)
